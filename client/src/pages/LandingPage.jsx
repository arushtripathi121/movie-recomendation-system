...
const LandingPage = () => {
    ...
    return (
        <div class="min-h-screen bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100 flex flex-col">
            <PreHeader hideButtons={false}/>

            <div class="flex flex-col items-center justify-center flex-grow text-center px-10 py-20">
                <h1 class="text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 mb-5">
                ...
                <p onClick={handleSignUp} class="bg-gradient-to-r cursor-pointer from-blue-500 to-teal-500 text-white font-bold py-3 px-8 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                    Get Started Now
                </p>
            </div>
